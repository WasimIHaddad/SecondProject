...
using SecondProject.Core.Managers;
using SecondProject.Core.Managers.Interfaces;
using SecondProject.Core.Mapper;
...
namespace SecondProject
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<secdbContext>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "SecondProject", Version = "v1" });
            ...
            services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
                .AddJwtBearer(options =>
                {
                    options.TokenValidationParameters = new TokenValidationParameters
                    {
                        ...
                        Encoding.UTF8.GetBytes("#test.key*&^vanthisismycustomSecretkeyforAuthentication")
                        )
                    };
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "SecondProject v1"));
            }
